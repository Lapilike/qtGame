...
{
    renderer.drawSprite(*anim[IDLE]->spriteSheet(), anim[IDLE]->currentFrame(), anim[IDLE]->totalFrames(), m_Pos, m_Size, m_Direct);
...
{
    renderer.drawSprite(*anim[IDLE]->spriteSheet(), anim[IDLE]->currentFrame(), anim[IDLE]->totalFrames(), angle, m_Pos, m_Size, m_Direct);
    if(anim[IDLE]->increaseCurrFrame())
        return true;
