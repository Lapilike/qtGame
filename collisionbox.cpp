...
bool CollisionBox::checkIntersect(CollisionBox obstacle)
{
    ...
    CollisionVector[0] = (ObstacleBorder[0] >= CollisionBorder[1]) && (ObstacleBorder[1] <= CollisionBorder[0]);
    CollisionVector[1] = (ObstacleBorder[2] >= CollisionBorder[3]) && (ObstacleBorder[3] <= CollisionBorder[2]);
